...
<form action="<?php echo JRoute::_('index.php?option=com_massmailer&view=import&layout=upload'); ?>" method="post" name="adminForm" id="item-form" class="form-validate" enctype="multipart/form-data">
	<fieldset class="adminform">
		<legend><?php echo JText::_( 'COM_MASSMAILER_IMPORT_DETAILS' ); ?></legend>
		<ul class="adminformlist">
			<li>
				<label for="id_csv_file"><?php echo JText::_('COM_MASSMAILER_IMPORT_CSV_FILE_LABEL') ?></label>
				<input id="id_csv_file" class="inputbox required" name="csv_file" type="file" />
			</li>
			<li>
				<label for="id_skip_first"><?php echo JText::_('COM_MASSMAILER_IMPORT_SKIP_FIRST_LABEL') ?></label>
